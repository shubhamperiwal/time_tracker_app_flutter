...
class SignInPage extends StatelessWidget {
  ...
  static Widget create(BuildContext context){
    ...
    // it's a special provider to use with value notifier
    return ChangeNotifierProvider<ValueNotifier<bool>>(
      create: (_) => ValueNotifier<bool>(false),

      // By using consumer, we're adding widget as listener so that it is rebuilt when value changes
      // this builder is called eveyr time the value changes
  ...
  Widget _buildContent(BuildContext context) {
    return Padding(
      ...
      SizedBox(height: 8.0),
			SignInButton(
        key: emailPasswordKey, //for test clsas
