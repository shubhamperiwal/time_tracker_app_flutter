...
class _EmailSignInFormStatefulState extends State<EmailSignInFormStateful> {
  ...
  void _emailEditingComplete(){
    // dont shift focus if email is invalid
  ...
  TextField _buildPasswordTextField() {
    ...
    return TextField(
      key: Key('password'), //used for testing
  ...
  TextField _buildEmailTextField() {
    ...
    return TextField(
      key: Key('email'), //used for testing
  ...
  _updateState() {
    // just rebuilds form. Dont need to manually update any state
    setState((){});
  }
}